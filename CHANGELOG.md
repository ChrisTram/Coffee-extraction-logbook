...
- v8.78 : lot 8 de l'audit, seconde moitié, le ménage de fond. Rien ne change à l'écran, sauf les titres : Instrument Serif n'existe qu'en un poids et le navigateur leur dessinait un faux gras, ils retrouvent leur trait. Le badge « en stock » perd sa dernière teinte verte. Les deux plus gros fichiers sont découpés : le tableau de bord en trois (les constats, la dernière tasse, le reste), la saisie en trois (le formulaire, le panneau latéral, les pilules). La feuille de style passe en quatre feuilles chargées dans l'ordre (socle, écrans, fenêtres, finitions), sans rien déplacer, et le voile des fenêtres devient un jeton. Du CSS mort part.
- v8.77 : lot 8 de l'audit, première moitié. En anglais, les recettes d'origine sont enfin traduites en entier : sous-titres, étapes, « pour qui », notes, dans le Guide, le panneau de la saisie, le pas à pas et le mode Brassage ; une recette que tu as modifiée garde son texte. Deux actions qui existaient sans bouton en ont un : « Supprimer ce sachet » dans la fiche café, pour un sachet saisi par erreur, et « Délier le dossier » dans Données. L'import accepte le fichier complet exporté (JSON). Du code mort part, et un café nommé « constructor » ne casse plus l'anglais.
- v8.76 : lot 7 de l'audit, pour tous les doigts. Le menu « Plus » du téléphone, une fois fermé, n'est plus atteignable au clavier ni au lecteur d'écran ; ouvert, le focus va sur sa première entrée et revient sur « Plus » à la fermeture. Les fenêtres portent le nom de leur titre, les champs du tableau des recettes de Paramètres sont nommés, la bulle d'une tasse dit laquelle elle montre, et les icônes décoratives sont tues. En thème clair, le texte atténué, l'accent et l'erreur passent 4,5:1 sur les surfaces de survol, et les bordures des champs se voient enfin (3,3:1). Un bocal ou un ruban pris au clavier porte un contour net, et les entrées du menu font 44 px de haut au doigt.
- v8.75 : lot 6 de l'audit, plus rapide. Les calculs de chaque tasse (ratio, âge du sachet…) sont gardés en mémoire tant qu'elle ne change pas, au lieu d'être refaits pour tout l'historique à chaque rendu et à chaque frappe. Une synchro qui ne rapporte rien ne redessine plus que sa pastille, les dessins ne sont plus redessinés deux fois, et les graphiques se mettent à jour sans être reconstruits ni réanimés. L'historique s'affiche par tranches de cent. Les polices et les graphiques sont préchargés, et le serveur retire les commentaires de la feuille de style et de la page avant de les envoyer : 42 Ko compressés deviennent environ 20 pour la feuille, sans rien changer aux sources.
- v8.74 : lots 4 et 5 de l'audit, un Guide qui dit vrai et exact, avec deux nouveautés. En tête des recettes, un tableau « Quel café, quelle recette » : le procédé en ligne, la torréfaction en colonne, et dans chaque case la recette de départ, sa température, une autre à essayer, ta moyenne sur les cafés de ce profil et ta meilleure recette quand une autre fait mieux. Sept goûts rejoignent la liste (salé, métallique, cassis, prune, orange, sucre de canne, cuir), et terreux, boisé et tabac quittent les défauts pour une famille « Terre et bois ». Le Guide ne se contredit plus : la correction chiffrée parle de deux crans comme les pas par défaut, ne propose plus de monter le feu de la Brikka ni d'ajouter du café dans un panier plein, les recettes ne sont plus citées par numéro, la balance n'est plus « le vrai manque » et le mode Brassage affiche les grammes par défaut. Il est plus exact : Bialetti dit eau froide pour toutes ses cafetières, l'aigreur (pas l'acidité) signe la sous-extraction, l'astringence vient aussi d'une canalisation, la fraîcheur tient compte des 30 °C, la norme SCA de l'eau est corrigée. Les cafés notés pour la Brikka qui ne sont pas des rang bơ ont leur propre message. Et les tableaux du Guide, masqués sur téléphone par erreur, sont de retour, comme la comparaison de deux tasses.
- v8.73 : lot 3 de l'audit, fermer à clé. Un nom de café, un commentaire ou un texte de recette piégé (arrivé par un CSV ou la synchro) ne peut plus exécuter de code dans le site : les chevrons sont neutralisés dès l'entrée, une seule fonction d'échappement sert partout, et le serveur impose une politique de sécurité qui n'autorise que les scripts du site. La connexion est limitée à dix essais par minute et par adresse. Les CSV exportés ne déclenchent plus de formule à l'ouverture au tableur.
- v8.72 : lot 2 de l'audit, les bugs qu'on voit. Plus besoin de recharger deux fois : au retour sur l'appli, une nouvelle version se signale par « Nouvelle version du carnet prête · Recharger ». Le site s'affiche tout de suite avec tes données locales et se synchronise ensuite, au lieu d'attendre la synchro ; en réseau faible, la page n'attend plus le réseau plus de trois secondes. Le bouton Fermer de la comparaison marche, « Nouvelle tasse » n'apparaît plus en double dans le menu du téléphone, la barre d'état prend la couleur de ta palette dès l'ouverture et le sommaire du Guide colle bien en haut. Un sachet acheté d'avance, sans date d'ouverture, ne devient plus le sachet en cours. Les fichiers CSV liés ne s'arrêtent plus en silence : le badge dit « à réautoriser ». Et les bips se débloquent sur iPhone, le brouillon garde « ratée » et l'agitation, l'historique trie les noms avec leurs accents.
- v8.71 : lot 1 de l'audit, ne plus rien perdre. Les tasses ont des identifiants uniques (deux appareils pouvaient créer la même et l'une écrasait l'autre). La synchro fusionne sa réponse avec ce que tu as saisi entre-temps au lieu de l'écraser, se relance après un échec et au retour sur l'appli, et corrige l'horloge de l'appareil. Un onglet resté sur une ancienne version ne peut plus effacer les colonnes récentes : le serveur le refuse et l'appli propose de recharger. L'import reconnaît chaque table (les achats écrasaient les extractions), fusionne au lieu de remplacer et montre un aperçu avant. « Exporter tout » donne les six tables et un fichier complet réimportable. Le serveur garde une copie quotidienne sur trente jours et n'écrase jamais un document illisible. Un champ absent reste vide au lieu de devenir 0, « Vider » vide vraiment, et deux touches sur Enregistrer ne font plus de doublon.
- v8.70 : nouvelle recette 10, la Tetsu Devil, la recette Switch de Tetsu Kasuya (février 2023, avec sa vidéo) : percolation à 90 °C puis immersion à 70 °C, ramenée à 15 g pour 210 g. Le 70 °C se fait sans thermomètre, par un mélange pesé dans un verre sur la balance, écrit dans l'étape 2 : 81 g d'eau à 90 °C et 39 g d'eau potable à température ambiante. La note donne aussi la variante au glaçon. Les grammes du mélange suivent l'eau totale comme les autres versements.
- v8.69 : le Tetsu 4:6 se lit comme les autres recettes. Ses étapes donnent le TOTAL à atteindre sur la balance, le versement entre parenthèses (« Verser jusqu'à 90 g, soit 60 g »), avec un horaire toutes les 45 secondes : 0:00, 0:45, 1:30, 2:15, 3:00, écoulement à 3:30. Le chrono bipe maintenant à chaque versement, et le mode Brassage affiche 90, 135, 180 g au lieu du versement seul. Et dans la saisie, la vidéo de la recette apparaît dans le panneau de droite, sous la fiche recette ; elle ne se coupe pas quand tu remplis le formulaire.
- v8.68 : le curseur de note n'a plus qu'une seule allure. Avant d'être touché, il se dessinait en pointillé sans poignée, puis changeait de style au premier toucher : deux curseurs pour un. Il garde maintenant toujours sa poignée et sa piste ; « pas encore notée » se lit dans le libellé au-dessus, et une tasse non touchée reste enregistrée sans note, comme avant. Même chose dans la saisie rapide et le mode Brassage.
- v8.67 : le tableau de bord remonte les dernières extractions. « Ta semaine » passe dans l'en-tête, à droite du titre, resserrée : ses faits dans la ligne du titre, la meilleure tasse sur une ligne. La dernière tasse et les chiffres clés prennent moins de hauteur (ratio, temps, mouture, coût : libellé et valeur sur une ligne). Les dernières extractions et le calendrier viennent juste après, avant le graphe des 30 jours et « Ce que tes données disent ». Sur un écran de 900 px de haut, le tableau commence à 545 px au lieu de 1074.
- v8.66 : la frise des sachets ne garde plus « en cours » un sachet qui ne sert plus. Il suffisait qu'il reste du café au calcul, fait depuis les doses saisies, pour que le ruban s'étire jusqu'à aujourd'hui : un sachet fini sans que les grammes tombent pile à zéro restait ouvert des semaines. Un sachet est maintenant en cours s'il lui reste du café ET qu'il a servi dans les deux dernières semaines ; sinon son ruban s'arrête à sa dernière tasse. Un vieux sachet sans aucune tasse n'est plus dessiné.
- v8.65 : « The Tetsu Devil » s'appelle maintenant « Tetsu 4:6 ». C'est la méthode 4:6 de Tetsu Kasuya, pas sa recette « Devil », qui se fait à deux températures. Tes tasses déjà faites et tes cafés associés suivent le nouveau nom, sur tous tes appareils ; les variantes pilotables restent les mêmes.
- v8.64 : les recettes du Guide ont leur vidéo. Sous les réglages de la carte, « ▶ Voir la vidéo » ouvre le lecteur YouTube dans la carte, seulement quand tu le touches, et « Ouvrir sur YouTube » l'ouvre à part. Sept recettes en ont une : la Chronicler et sa Sweet, la Better 1 Cup de Hoffmann, la One and Done de Lance Hedrick, le 4:6 de Tetsu (une démonstration de TALES COFFEE), la Sherrycipe (présentée par The Coffee Chronicler) et la Tetsu Neo Brew. Le lien se modifie dans l'éditeur de recette, nouveau champ « Vidéo ou source », et un lien qui n'est pas YouTube s'affiche en « Voir la source ».
...
- v8.59 : la température estimée du Switch suit une courbe, plus une droite. La droite de 28 à 100 °C annonçait 82 °C à 1:30, alors que tes premières bulles remontent déjà : une bouilloire chauffe vite au début et ralentit près de l'ébullition. La courbe passe par deux repères que tu chronomètres dans Paramètres, carte Ma bouilloire : les premières bulles qui remontent (88 °C, 1:30 par défaut, nouveau champ) et le gros bouillon (100 °C, 2:00). Avec tes temps : 1:00 donne 73 °C, 1:30 donne 88, 1:40 donne 92. Les tasses déjà enregistrées dont tu n'avais pas retouché le degré passent sur la nouvelle courbe.
