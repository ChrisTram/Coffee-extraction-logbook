...
const I18N_EN = {
  ...
  T: {
    ...
    te_ligne: "pour <b>{p} g</b>, running total {c} g",
    te_fin: "Pour each time the bed surface has just gone dry, roughly every 30 to 45 seconds.",
    pap_demarrer: "Start",
    pap_arreter: "Stop",
    pap_reprendre: "Restart from zero",
    pap_verser: "Pour {p} g{b}, running total {c} g. Wait until the bed surface goes dry.",
    pap_bloom: " (bloom)",
    ...
    t_export_tout: "cafes.csv, extractions.csv and recettes.csv downloaded",
