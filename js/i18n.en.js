...
const I18N_EN = {
  ...
  T: {
    ...
    w_rangbo: "Rang bơ coffee: the paper filter holds back some of the butter. Worth trying anyway, at a lower temperature, and worth logging.",
  ...
  UI: {
    ...
    "Deux repères à chronométrer une fois, sur le feu habituel, depuis l'eau du robinet. Les premières bulles : beaucoup de petites bulles au fond et quelques-unes qui remontent, vers 88 degrés. Le gros bouillon : toute la surface roule, 100 degrés. En saisie Switch, le temps passé sur le feu donne la température estimée, sur une courbe qui passe par ces deux repères : la montée ralentit en approchant de l'ébullition. Une estimation, pas une mesure : le degré reste modifiable.": "Two landmarks to time once, on the usual flame, from tap water. First bubbles: many small bubbles on the bottom with a few rising, around 88 degrees. Rolling boil: the whole surface rolls, 100 degrees. In a Switch entry, the time on the stove gives the estimated temperature, on a curve through both landmarks: the rise slows down as the water nears boiling. An estimate, not a measurement: the degree stays editable.",
    ...
    "Libre, par exemple : superbe tasse, ronde et sucrée": "Free text, for example: superb cup, round and sweet",
      ...
      ": un retrait de caféine, pas une fermentation. Swiss Water, sucre de canne (EA) et CO2 supercritique sont les plus propres. Plus poreux, il se brasse un peu plus chaud et un peu plus fin.": ": a caffeine removal, not a fermentation. Swiss Water, sugar cane (EA) and supercritical CO2 are the cleanest. More porous, it brews a little hotter and a little finer.",
      "Ce que ça change pour mes recettes": "What it changes for my recipes",
      ": un lavé va vers la percolation pure, Better 1 Cup ou One and Done, eau chaude, je cherche la clarté. Un honey va vers la Chronicler, sucre et corps sans perdre le détail. Un natural aussi, ou en immersion, à 90 ou 92 degrés, sinon le ferment et l'amertume ressortent, et un numéro plus gros à la molette, il est moins dense. Un anaerobic : Chronicler à 88 ou 90 degrés, ses arômes sont volatils et ça vire vite au sucré écœurant.": ": a washed goes to pure percolation, Better 1 Cup or One and Done, hot water, I am after clarity. A honey goes to the Chronicler, sweetness and body without losing detail. A natural too, or immersion, at 90 or 92 degrees, otherwise the ferment and the bitterness come out, and one number coarser on the dial, it is less dense. An anaerobic: Chronicler at 88 or 90 degrees, its aromas are volatile and it soon turns sickly sweet.",
      ...
      "Eau froide ou eau chaude, ça dépend de la machine": "Cold water or hot water, it depends on the brewer",
      "La Brikka se remplit à l'EAU FROIDE. C'est la consigne Bialetti pour ce modèle : sa soupape lestée est calibrée sur la montée en pression que produit l'eau froide, et la remplir chaud fait lâcher la soupape trop tôt.": "The Brikka is filled with COLD water. That is Bialetti's instruction for this model: its weighted valve is calibrated on the pressure ramp cold water produces, and filling it hot makes the valve release too early.",
      "La Moka Express, elle, se remplit à l'eau préchauffée. C'est de là que vient le conseil qu'on lit partout, et il ne se transpose pas à la Brikka.": "The Moka Express, on the other hand, is filled with preheated water. That is where the advice you read everywhere comes from, and it does not carry over to the Brikka.",
      "Conséquence directe : sur une Brikka, un temps total de 6 à 8 minutes est normal. La mouture ne cuit pas pendant tout ce temps, elle reste tiède tant que l'eau du dessous n'est pas près de bouillir. Le temps qui compte est celui qui sépare les premières gouttes des premiers gargouillis, pas le temps total.": "Direct consequence: on a Brikka a total time of 6 to 8 minutes is normal. The grounds are not baking that whole time, they stay lukewarm until the water below is close to boiling. The time that matters is the one between the first drops and the first gurgles, not the total.",
      "La recette Brikka classique du carnet part donc à l'eau froide. La variante eau préchauffée applique volontairement la méthode de la Moka Express, pour pouvoir comparer les deux en connaissance de cause.": "So the logbook's Brikka classique recipe starts from cold water. The preheated variant deliberately applies the Moka Express method, so the two can be compared knowingly.",
      ...
      "Sur le Switch, tout est réglable et Le Costaud (Bloom) est déjà la recette des torréfactions claires : 95 degrés, la plus chaude des dix, et un bloom qui sert à saturer un grain dense. Pour un medium, la Chronicler ou la Sherrycipe.": "On the Switch everything is adjustable, and Le Costaud (Bloom) is already the light roast recipe: 95 degrees, the hottest of the ten, with a bloom whose job is to saturate a dense bean. For a medium, the Chronicler or the Sherrycipe.",
  ...
  TAGS_INFO: {
    ...
    "terreux": "Wet earth, forest floor, mushroom: common in robustas.",
    "boisé": "Dry wood, pencil, barrel: often an aged coffee.",
