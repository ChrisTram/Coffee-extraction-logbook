...
const I18N_EN = {
  ...
  T: {
    ...
    temp_estimee: "{d} on the stove gives about {t} °C (it boils in {e}).",
    temp_conseil: "For {t} °C, leave the kettle about {d} on the stove (it boils in {e}).",
  ...
  UI: {
    ...
    "À chronométrer une fois : le temps qu'elle met, sur le feu habituel, de l'eau du robinet au gros bouillon, quand toute la surface roule. Pas les premières petites bulles, qui sont l'air dissous qui sort vers 60 ou 70 degrés. En saisie Switch, le temps passé sur le feu donne alors la température estimée, en montée linéaire de 28 à 100 degrés. Une estimation, pas une mesure : le degré reste modifiable. Vide tant que tu n'as pas mesuré, et le site n'estime rien.": "Time it once: how long it takes, on the usual flame, from tap water to a rolling boil, when the whole surface rolls. Not the first small bubbles, which are dissolved air leaving around 60 or 70 degrees. In a Switch entry, the time on the stove then gives the estimated temperature, rising linearly from 28 to 100 degrees. An estimate, not a measurement: the degree stays editable. Empty until you have measured, and the site estimates nothing.",
