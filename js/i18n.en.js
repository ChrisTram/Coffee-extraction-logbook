...
const I18N_EN = {
  ...
  UI: {
    ...
    "Libre, par exemple : superbe tasse, ronde et sucrée": "Free text, for example: superb cup, round and sweet",
      ...
      "Feu": "Flame",
      "Mouture": "Grind",
      "Extraction ratée": "Botched extraction",
      "Un geste manqué, pas un réglage. Exclue des analyses, gardée dans les comptages.": "A missed move, not a setting. Left out of the analyses, kept in the counts.",
