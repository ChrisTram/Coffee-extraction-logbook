...
const I18N_EN = {
  ...
  UI: {
    ...
    "Le temps qu'elle met à bouillir depuis l'eau du robinet, sur le feu habituel. En saisie Switch, le temps passé sur le feu donne la température estimée, en montée linéaire de 28 à 100 degrés. Une estimation, pas une mesure : le degré reste modifiable.": "How long it takes to boil from tap water, on the usual flame. In a Switch entry, the time on the stove gives the estimated temperature, rising linearly from 28 to 100 degrees. An estimate, not a measurement: the degree stays editable.",
