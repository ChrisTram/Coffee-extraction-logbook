...
const I18N_EN = {
  ...
  T: {
    ...
    ins_cafe_levier: "On your {cafe} in the {machine}: {levier} {valeur} averages {haut} over {n} cups, against {bas} for the rest.",
    ...
    ins_paquet: "Your cups are better {quand}: {haut} on average against {bas} the rest of the time.",
    ins_recettes: "{gagnante} beats {perdante}: {haut} average against {bas}.",
    ins_moment_matin: "in the morning",
    ins_moment_aprem: "in the afternoon",
    ins_moment_soir: "in the evening",
    ins_moment: "Your cups {quand} come out better: {haut} average against {bas} for the rest of the day.",
    ins_puissance: "On the Brikka, a flame power of {feu} works better for you: {haut} average against {bas} at other settings.",
