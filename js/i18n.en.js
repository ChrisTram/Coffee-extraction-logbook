...
const I18N_EN = {
  ...
  UI: {
    ...
    "À chronométrer une fois, sur le feu habituel, de l'eau du robinet au gros bouillon, quand toute la surface roule. Repère intermédiaire : beaucoup de petites bulles au fond et quelques-unes qui montent, c'est 85 à 90 degrés, pas encore l'ébullition ; le gros bouillon arrive une trentaine de secondes plus tard. Sur ta bouilloire ce repère tombe vers 1:30, d'où le 2:00 posé ici. En saisie Switch, le temps passé sur le feu donne la température estimée, en montée linéaire de 28 à 100 degrés. Une estimation, pas une mesure : le degré reste modifiable.": "Time it once, on the usual flame, from tap water to a rolling boil, when the whole surface rolls. Halfway landmark: many small bubbles on the bottom with a few rising is 85 to 90 degrees, not yet boiling; the rolling boil comes about thirty seconds later. On your kettle that landmark falls around 1:30, hence the 2:00 set here. In a Switch entry, the time on the stove gives the estimated temperature, rising linearly from 28 to 100 degrees. An estimate, not a measurement: the degree stays editable.",
