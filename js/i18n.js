...
const I18N = (() => {
  ...
  const T = {
    ...
    pl_rang: { fr: "{k}e sur {n}" },
    pl_au_dessus: { fr: "{x} au-dessus de ta moyenne" },
    pl_au_dessous: { fr: "{x} sous ta moyenne" },
    pl_dans_moyenne: { fr: "dans ta moyenne" },
    pl_moyenne: { fr: "ta moyenne {m}" },
    pl_aria: { fr: "{n} tasses notées de {cafe}, moyenne {m}, celle-ci à {note}" },
    ...
    lec_recettes_deux: { fr: "{a} passe devant {b}, {ma} contre {mb}." },
    lec_switch_devant: { fr: "Le Switch fait mieux que la Brikka de {x} point{s} en moyenne.{souvent}" },
    lec_brikka_devant: { fr: "La Brikka fait mieux que le Switch de {x} point{s} en moyenne.{souvent}" },
    lec_souvent_brikka: { fr: " La Brikka reste celle que tu utilises le plus." },
    lec_souvent_switch: { fr: " Le Switch reste celui que tu utilises le plus." },
    lec_machines_egal: { fr: "Les deux machines se valent : {mb} en Brikka, {ms} au Switch." },
    lec_gouts: { fr: "Tes bonnes tasses parlent de {a}. {p} tire la note vers le bas." },
    lec_gouts_sans_pire: { fr: "Tes bonnes tasses parlent de {a}." },
    lec_et: { fr: " et de " },
    lec_diag: { fr: "Le diagnostic le plus fréquent : {d}, {n} fois sur {t}." },
    lec_mouture_brikka: { fr: "À la Brikka, la molette {d} donne ta meilleure moyenne : {x} sur {n} tasses." },
    lec_mouture_switch: { fr: "Au Switch, la molette {d} donne ta meilleure moyenne : {x} sur {n} tasses." },
    axe_note_court: { fr: "note" },
    axe_tasses: { fr: "tasses" },
    l_tasses_jour: { fr: "Tasses du jour" },
    ins_contre: { fr: "<b>{h}</b> contre {b}" },
    ins_effectifs: { fr: "{h} et {b} tasses" },
    ...
    sync_perimee: { fr: "Une version plus récente du carnet est en ligne : recharge la page pour synchroniser." },
    maj_recharger: { fr: "Recharger" },
    maj_prete: { fr: "Nouvelle version du carnet prête." },
    f_reautoriser: { fr: "à réautoriser, touche ici" },
    f_reautorise: { fr: "Dossier réautorisé : les CSV sont de nouveau écrits." },
    f_refuse: { fr: "Permission refusée : les CSV ne sont pas écrits, tes données restent ici et sur le serveur." },
    t_stockage_ko: { fr: "Impossible d'enregistrer sur cet appareil (stockage plein ?). La synchro garde une copie." },
    imp_inconnue: { fr: "Fichier non reconnu : ni cafés, ni extractions, ni recettes, ni tasses, ni sachets, ni réglages." },
    imp_json_illisible: { fr: "Ce fichier JSON n'est pas un export complet du carnet." },
    imp_apercu: { fr: "{n} lignes pour la table {t} : {nv} nouvelles, {md} modifiées. Les lignes absentes du fichier restent en place." },
    imp_apercu_tout: { fr: "Export complet du carnet, {n} lignes, fusionnées avec les tiennes comme une synchro." },
    imp_sans_id: { fr: "{n} sans identifiant en recevront un." },
    imp_doublons: { fr: "{n} identifiants en double : la dernière ligne gagne." },
    imp_ok: { fr: "Importer" },
    ...
    temp_estimee: { fr: "{d} sur le feu donne environ {t} °C." },
    temp_conseil: { fr: "Pour {t} °C, laisse la bouilloire environ {d} sur le feu." },
    ...
    t_param_bulles: { fr: "Les premières bulles viennent avant le gros bouillon : un temps plus court que l'ébullition." },
    ...
    h_surligne: { fr: "{n} tasse{s} depuis le {d}" },
    h_res_tasses: { fr: "tasses" },
    h_res_moyenne: { fr: "moyenne" },
    h_res_meilleure: { fr: "la meilleure" },
    h_res_ratees: { fr: "ratées" },
    h_res_aucune: { fr: "aucune" },
    hm_titre: { fr: "Les {n} dernières semaines" },
    hm_leg_moins: { fr: "moins" },
    hm_leg_plus: { fr: "4 et plus" },
    ...
    dictee: { fr: "Dicter" },
    dictee_ecoute: { fr: "J'écoute, touche pour finir" },
    dictee_refusee: { fr: "Le micro est refusé : autorise-le dans les réglages du navigateur" },
    dictee_reseau: { fr: "La dictée a besoin d'une connexion" },
    j_titre: { fr: "Tes tasses jumelles" },
    j_regle: { fr: "Même recette, molette à {c} crans près." },
    j_regle_moulu: { fr: "Même recette, même café." },
    j_meme: { fr: "même café, même molette" },
    j_meme_moulu: { fr: "même café" },
    j_autre_cafe: { fr: "un autre café" },
    j_molette: { fr: "molette {d} ({c})" },
    j_feu: { fr: "feu {f}" },
    j_cran: { fr: "{n} cran" },
    j_crans: { fr: "{n} crans" },
    j_moyenne: { fr: "Moyenne {m} sur {n} tasses." },
    roue_fois: { fr: "{n} fois" },
    ...
    bi_video: { fr: "▶ Voir la vidéo" },
    bi_youtube: { fr: "Ouvrir sur YouTube" },
    bi_source: { fr: "Voir la source" },
    ...
    de_trajectoire_vide: { fr: "Il faut {n} tasses notées de ce café avec une molette pour tracer ta trajectoire." },
    de_trajectoire_lecture: { fr: "{n} tasses de {r}, dans l'ordre. La meilleure : {d}, {c}, {x}." },
    de_degres: { fr: "{v} °C" },
    ...
    cc_temperature: { fr: "eau à {vers} °C au lieu de {de}" },
    cc_feu: { fr: "feu {vers} au lieu de {de}" },
    cc_eau: { fr: "{vers} g d'eau au lieu de {de}" },
    cc_dose: { fr: "{vers} g de café au lieu de {de}" },
    cc_preparer: { fr: "Préparer la prochaine" },
    cc_prete: { fr: "La prochaine tasse t'attend dans la saisie, correction appliquée" },
    ...
    t_export_tout: { fr: "Les six tables en CSV et le fichier complet carnet-complet.json téléchargés" },
    ...
    lait_deux: { fr: "{t} ml de tasse moins {v} ml de café : {e} ml à remplir. Verser {l} ml de lait froid en flat white, {c} ml en cappuccino : le lait gonfle en moussant, et plus il mousse moins il en faut." },
    ...
    tbl_tasses: { fr: "tasses" },
    tbl_achats: { fr: "sachets" },
    tbl_reglages: { fr: "réglages" },
    tbl_tout: { fr: "toutes les tables" },
